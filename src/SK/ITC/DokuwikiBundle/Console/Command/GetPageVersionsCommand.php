<?php
/**
 * SK ITC Dokuwiki Bundle Command Get Page Versions
 *
...
class GetPageVersionsCommand extends AbstractCommand
{
	...
	protected function configure()
	{
		...
		$this->addOption( "--offset", "o", InputOption::VALUE_REQUIRED, "Dokuwiki offset." );
	}
}